...
DROP SEQUENCE mwd.weav_ars_seq;
...
CREATE SEQUENCE mwd.weav_ars_seq INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 20;
...
ALTER TABLE mwd.american_wire_gauge
    ADD CONSTRAINT american_wire_gauge_pk PRIMARY KEY ( awg_id )
        USING INDEX mwd.american_wire_gauge_pk;

ALTER TABLE mwd.american_wire_gauge
    ADD CONSTRAINT american_wire_gauge_uk UNIQUE ( awg )
        USING INDEX mwd.american_wire_gauge_uk;


CREATE TABLE MWD.AMERICAN_WIRE_GAUGE_JN
 (JN_OPERATION CHAR(3) NOT NULL
 ,JN_ORACLE_USER VARCHAR2(30) NOT NULL
 ,JN_DATETIME DATE NOT NULL
 ,JN_NOTES VARCHAR2(240)
...
CREATE OR REPLACE TRIGGER MWD.AMERICAN_WIRE_GAUGE_JNtrg
  AFTER 
  INSERT OR 
  UPDATE OR 
  DELETE ON MWD.AMERICAN_WIRE_GAUGE for each row 
 Declare 
  rec MWD.AMERICAN_WIRE_GAUGE_JN%ROWTYPE; 
  blank MWD.AMERICAN_WIRE_GAUGE_JN%ROWTYPE; 
  BEGIN 
    rec := blank; 
    IF INSERTING OR UPDATING THEN 
    ...
    ELSIF DELETING THEN 
      ...
      rec.JN_OPERATION := 'DEL'; 
    END IF; 
    INSERT into MWD.AMERICAN_WIRE_GAUGE_JN VALUES rec; 
  END; 
...
ALTER TABLE mwd.imperial_fractions
    ADD CONSTRAINT imperial_fractions_uk UNIQUE ( inch_fraction )
        USING INDEX TABLESPACE bp LOGGING;
...
ALTER TABLE mwd.standard_wire_gauge
    ADD CONSTRAINT standard_wire_gauge_pk PRIMARY KEY ( swg_id )
        USING INDEX mwd.standard_wire_gauge_pk;

ALTER TABLE mwd.standard_wire_gauge
    ADD CONSTRAINT standard_wire_gauge_uk UNIQUE ( swg )
        USING INDEX mwd.standard_wire_gauge_uk;


CREATE TABLE MWD.STANDARD_WIRE_GAUGE_JN
 (JN_OPERATION CHAR(3) NOT NULL
 ,JN_ORACLE_USER VARCHAR2(30) NOT NULL
 ,JN_DATETIME DATE NOT NULL
 ,JN_NOTES VARCHAR2(240)
...
CREATE OR REPLACE TRIGGER MWD.STANDARD_WIRE_GAUGE_JNtrg
  AFTER 
  INSERT OR 
  UPDATE OR 
  DELETE ON MWD.STANDARD_WIRE_GAUGE for each row 
 Declare 
  rec MWD.STANDARD_WIRE_GAUGE_JN%ROWTYPE; 
  blank MWD.STANDARD_WIRE_GAUGE_JN%ROWTYPE; 
  BEGIN 
    rec := blank; 
    IF INSERTING OR UPDATING THEN 
    ...
    ELSIF DELETING THEN 
      ...
      rec.JN_OPERATION := 'DEL'; 
    END IF; 
    INSERT into MWD.STANDARD_WIRE_GAUGE_JN VALUES rec; 
  END; 
...
CREATE OR REPLACE TRIGGER MWD.AMERICAN_WIRE_GAUGE_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.AMERICAN_WIRE_GAUGE 
    FOR EACH ROW 
Declare 
  rec MWD.AMERICAN_WIRE_GAUGE_JN%ROWTYPE; 
  blank MWD.AMERICAN_WIRE_GAUGE_JN%ROWTYPE; 
...
CREATE OR REPLACE TRIGGER MWD.CLASPS_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.CLASPS 
    FOR EACH ROW 
Declare 
  rec MWD.CLASPS_JN%ROWTYPE; 
  blank MWD.CLASPS_JN%ROWTYPE; 
...
CREATE OR REPLACE TRIGGER MWD.LEGAL_PERSONS_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.LEGAL_PERSONS 
    FOR EACH ROW 
Declare 
  rec MWD.LEGAL_PERSONS_JN%ROWTYPE; 
  blank MWD.LEGAL_PERSONS_JN%ROWTYPE; 
...
CREATE OR REPLACE TRIGGER MWD.ORNAMENTS_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.ORNAMENTS 
    FOR EACH ROW 
Declare 
  rec MWD.ORNAMENTS_JN%ROWTYPE; 
  blank MWD.ORNAMENTS_JN%ROWTYPE; 
...
CREATE OR REPLACE TRIGGER MWD.SETS_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.SETS 
    FOR EACH ROW 
Declare 
  rec MWD.SETS_JN%ROWTYPE; 
  blank MWD.SETS_JN%ROWTYPE; 
...
CREATE OR REPLACE TRIGGER MWD.STANDARD_WIRE_GAUGE_JNTRG 
    AFTER INSERT OR UPDATE OR DELETE ON MWD.STANDARD_WIRE_GAUGE 
    FOR EACH ROW 
Declare 
  rec MWD.STANDARD_WIRE_GAUGE_JN%ROWTYPE; 
  blank MWD.STANDARD_WIRE_GAUGE_JN%ROWTYPE; 
